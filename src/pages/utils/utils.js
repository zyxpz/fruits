 ...
 * ios分享的坑
 * 重载页面
 * 分享已修复，不需要这种方式@2018年1月31日 10:08:10
 */
// export const shareReLoad = () => {
// 	if ( _global.shareCount && _global.device.ios && !getUrlParam('reload')) {
// 		let goToUrl = `${location.pathname}${location.search}`;
// 		goToUrl += goToUrl.indexOf('?') > -1 ? '&' : '?' + 'reload=1';
// 		history.replaceState(null, null, goToUrl);
